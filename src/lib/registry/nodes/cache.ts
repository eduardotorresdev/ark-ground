 ...
 * (can saturate on its own), a TTL that drives both a temporal warmth (cold →
 * warming → healthy) and a steady-state expiry erosion, and a working set of
 * distinct hot keys that sets how hard that expiry bites under load.
 */
